...
def page_query(df: pd.DataFrame) -> None:
    ...
    st.markdown(
        "**付款状态说明：**\n"
        "- 未付款 → 宝您的谷子已经成配，但是尚未付款\n"
        "- 已付定金 → 宝您定金已付，后续还需要补尾款哦\n"
        "- 已付全款 → 宝全款已付，谢谢惠顾，请耐心等待发货\n\n"
        "**发货状态说明：**\n"
        "- 已下单 → 宝您的谷子已经下单了，还没发货，到发了会第一时间联系您\n"
        "- 可国内排发 → 宝谷子已到国内，从国内排发ing，请联系对应老师\n"
        "- 可国际排发 → 宝谷子已到，囤货地在东京，团咪正在国际排发ing\n"
        "- 已排发 → 谷子正在跨越山海飞奔到您家里，请及时接收哦"
    )
